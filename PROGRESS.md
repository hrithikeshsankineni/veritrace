...
### Phase 0 — Scaffold
- [ ] **0.1 Repo scaffold.** Create the full directory structure from AGENTS.md §4, `requirements.txt`, `.env.example`, `.gitignore`, empty `__init__.py` files, and a starter `README.md`. *DoD:* `pip install -r requirements.txt` succeeds in a fresh venv; repo matches §4.
